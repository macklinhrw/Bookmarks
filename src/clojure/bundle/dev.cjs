...
if (__dirname == '.') { SHADOW_IMPORT_PATH = "/Users/macklinrw/Programming/sveltetest/.shadow-cljs/builds/dev/dev/out/cljs-runtime"; }
global.$CLJS = global;
